...
PBCast.prototype._initializePeer = function(id, server){
  ...
  peer.on('open', function(id){
    var connection = peer.connect(this._joinId);
    connection.on('open', function(){
      this._connections.push(connection);
      this._joined = true;
      this._emptyCacheMessage();
    });
  });
...
PBCast.prototype.join = function(id){
  this._joinId = id;
};

PBCast.prototype._join = function(){    
...
PBCast.prototype._emptyCacheMessage = function(){
  while(this._cacheMessage.length > 0){
    this.send(this._cacheMessage.shift());
  }
};
