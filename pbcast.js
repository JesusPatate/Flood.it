 ...
 * \brief ...
 */
function PBCast2(serverLocation){
	var self = this;
...
PBCast2.prototype = Object.create(EventEmitter.prototype);
PBCast2.prototype.constructor = PBCast2;

/**
 * \brief ...
 */
PBCast2.prototype.getId = function(){
	var id;
 ...
 *      ...
 */
PBCast2.prototype.localSend = function(message){
	if(this.ready){
		this._qvc.increment();
		self.emit('deliver', {error: error, clocks: this._qvc._clocks, id: this._id, local: false, msg: message});
	}
	else{
