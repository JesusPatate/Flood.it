define(['seedrandom', 'EventEmitter'], function(seedrandom, EventEmitter){
    var lseq = function(){
        var name = 'editor';
		...
		this.LSEQ.prototype = Object.create(EventEmitter.EventEmitter.prototype);
		this.LSEQ.prototype.constructor = this.LSEQ;
		 ...
		 *      offset.
		 */
		this.LSEQ.prototype.insert = function(offset, value, siteID, clock){
		 ...
		 *      ID of the new node.
		 */
		this.LSEQ.prototype.foreignInsert = function(id, value, siteID, clock) {
		 ...
		 *      offset.
		 */
		this.LSEQ.prototype.delete = function(offset){
			if(offset < 0 || offset > this.size()){
				throw new Error('Invalid offset');
			}
		 ...
		 */
		this.LSEQ.prototype.foreignDelete = function(id, siteID, clock){
		...
		this.LSEQ.prototype._getOffset = function(id) {
			var offset = 0;
		...
		this.LSEQ.prototype.size = function(){
		 ...
		 * /ul>
		 */
		this.LSEQ.prototype._compareIDs = function(id1, id2) {
			var res = 0;
			var stop = false;
			var i = 0;
		 ...
		 * \brief 
		 */
		this.LSEQ.prototype.onDelivery = function(message){
