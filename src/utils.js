define([], function(){
    var utils = function(){
		 ...
		 */
		this.Map.prototype.hasKey = function(key){
		 ...
		 *  map.
		 */
		this.Map.prototype.iterator = function(){
		 ...
		 */
		this.Queue.prototype.poll = function(){
		 ...
		 */
		this.Queue.prototype.add = function(element){
		 ...
		 */
		this.Queue.prototype.iterator = function(){
			return Iterator(this._elements);
		};
		 ...
		 *      ...
		 */
		this.PrimeCalculator.getNextPrime = function(bound){
			var sieve = [];
			var i = 2;
			var j;
			var primes = [1];
